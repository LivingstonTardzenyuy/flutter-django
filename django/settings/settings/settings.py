...
INSTALLED_APPS = [
    ...
    'allauth',
    'allauth.account',
    'allauth.socialaccount',  # Add this line if using social accounts
    'allauth.socialaccount.providers.google',  # Example for Google provider
    'allauth.socialaccount.providers.facebook',  # Example for Facebook provider
